        ...
        haskellPackages = pkgs.haskell.packages."${compiler}".override {
          overrides = self: super: (
            (extra-deps super) // {
              ...
              laboratorium = pkgs.haskell.lib.overrideCabal 
		(super.callCabal2nix "laboratorium" (gitignoreSource ../.) {})
		(old: {enableLibraryProfiling = false; enableExecutableProfiling = false;});
            }
          );
        };
      };
